package cn.ichengxi.fang.view.swipe;
...
public class SwipeLayout extends FrameLayout {
    ...
    private void init() {
        ...
        dragHelper = ViewDragHelper.create(this, 1500, callback);
        dragHelper.setMinVelocity(250);
        // 获取系统认为的滑动的临界值
    ...
    ViewDragHelper.Callback callback = new ViewDragHelper.Callback() {
        ...
        public void onViewPositionChanged(View changedView, int left, int top, int dx, int dy) {
            ...
            Log.d("ss", "onViewPositionChanged() called with: deleteView.getLeft() = [" + deleteView.getLeft()
                    + "], contentView.getMeasuredWidth() = " + contentView.getMeasuredWidth() + ", " + isOpen());

            if (isOpen()) {
                if (openListener != null) openListener.open();
            } else {
                if (openListener != null) openListener.close();
            }
        }
    ...
    public void computeScroll() {
        if (dragHelper.continueSettling(true)) {
            Log.d("ss", "computeScroll() called  " + deleteView.getLeft() + "， contentView.getMeasuredWidth() = " + contentView.getMeasuredWidth());
            ViewCompat.postInvalidateOnAnimation(SwipeLayout.this);
    ...
    private BaseRecyclerView findRecycleView() {
        ViewParent p = getParent();
        View child = this;
        while (p != null) {
            if (child instanceof BaseRecyclerView) {
                return (BaseRecyclerView) child;
            }
    ...
    private boolean isOpen() {
        return deleteView.getLeft() < contentView.getMeasuredWidth();
    }
